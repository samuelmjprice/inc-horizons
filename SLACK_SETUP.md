...
- Slack sidebar sections were created in Samuel's sidebar: `INTERNATIONAL COLLECTIVE`, `DIRECT WORK`, `BUSINESS DIVISIONS`, `INC CIRCLE`, `HORIZONS EVENT`, and `HORIZONS ADMIN / TESTING`.
